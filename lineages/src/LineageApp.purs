...
import LineageData (lineages)
import LineageTypes (Lineage)
...
filterItem :: Model -> Lineage -> Boolean
...
updateHref xs =
  case indexOf (Pattern "http://dnd5e.wikidot.com/lineage:") xs of
    Nothing -> xs
    Just _  -> "lineage.html#" <> drop 40 xs