...
commonItems =
  ...
  , { title: "Masquerade Tattoo"
    ...
    , description: 
      ...
      , P [ T "Tattoo Attunement. To attune to this item, you hold the needle to your skin where you want the tattoo to appear, pressing the needle there throughout the attunement process. When the attunement is complete, the needle turns into the ink that becomes the tattoo, which appears on the skin." ]
      , P [ T "If your attunement to the tattoo ends, the tattoo vanishes, and the needle reappears in your space." ]
      , P [ T "Fluid Ink. As a bonus action, you can shape the tattoo into any color or pattern and move it to any area of your skin. Whatever form it takes, it is always obviously a tattoo. It can range in size from no smaller than a copper piece to an intricate work of art that covers all your skin." ]
      , P [ T "Disguise Self. As an action, you can use the tattoo to cast the Disguise Self spell (DC 13 to discern the disguise). Once the spell is cast from the tattoo, it can't be cast from the tattoo again until the next dawn."  ]
      ]
    }
  ...
  , { title: "Orb of Shielding"
    ...
    , description: 
      ...
      , P [ T "Fernian basalt: Fire" ]
      , P [ T "Irian quartz: Radiant" ]
      , P [ T "Kythrian skarn: Acid and poison" ]
      , P [ T "Lamannian flint: Lightning and thunder" ]
      , P [ T "Mabaran obsidian: Necrotic" ]
      , P [ T "Risian shale: Cold" ]
      , P [ T "Shavarran chert: Force" ]
      , P [ T "Xorian marble: Psychic" ]
      ]
    }
  , { title: "Orb of Time"
    , rarity: [ RarityCommon ]
  ...
  , { title: "Potion of Healing"
    ...
    , P [ T "Healing (Common): 2d4 + 2" ]
    , P [ T "Greater healing (Uncommon): 4d4 + 4" ]
    , P [ T "Superior healing (Rare): 8d4 + 8" ]
    , P [ T "Supreme healing (Very rare): 10d4 + 20" ]
    ]
    }
  ...
  , { title: "Spell Scroll"
    ...
    , description: 
      ...
      , P [ T "Cantrip: Common, Save DC 13, Attack bonus +5" ]
      , P [ T "1st: Common, Save DC 13, Attack bonus +5" ]
      , P [ T "2nd: Uncommon, Save DC 13, Attack bonus +5" ]
      , P [ T "3rd: Uncommon, Save DC 15, Attack bonus +7" ]
      , P [ T "4th: Rare, Save DC 15, Attack bonus +7" ]
      , P [ T "5th: Rare, Save DC 17, Attack bonus +9" ]
      , P [ T "6th: Very rare, Save DC 17, Attack bonus +9" ]
      , P [ T "7th: Very rare, Save DC 18, Attack bonus +10" ]
      , P [ T "8th: Very rare, Save DC 18, Attack bonus +10" ]
      , P [ T "9th: Legendary, Save DC 19, Attack bonus +11" ]
  ...
  , { title: "Spellwrought Tattoo"
    ...
    , description: 
      ...
      , P [ T "Cantrip (Common), Spellcasting Ability Modifier +3, Save DC 13, Attack bonus +5" ]
      , P [ T "1st (Common), Spellcasting Ability Modifier +3, Save DC 13, Attack bonus +5" ]
      , P [ T "2nd (Uncommon), Spellcasting Ability Modifier +3, Save DC 13, Attack bonus +5" ]
      , P [ T "3rd (Uncommon), Spellcasting Ability Modifier +4, Save DC 15, Attack bonus +7" ]
      , P [ T "4th (Rare), Spellcasting Ability Modifier +4, Save DC 15, Attack bonus +7" ]
      , P [ T "5th (Rare), Spellcasting Ability Modifier +5, Save DC 17, Attack bonus +9" ]
      ]
    }
  ...
  , { title: "Vox Seeker"
    ...
    , description: 
      ...
      , P [ T "Vox Seeker - Tiny construct, unaligned" ]
      , P [ T "Armor Class: 14 (natural armor)" ]
      , P [ T "Hit Points: 7 (2d4 + 2)" ]
      , P [ T "Speed: 20 ft., climb 20 ft." ]
      , P [ T "STR: 2 (-4). DEX: 10 (+0). CON: 12 (+1). INT: 1 (-5). WIS: 10 (+0). CHA: 1 (-5)." ]
      , P [ T "Damage Immunities: poison, psychic" ]
      , P [ T "Condition Immunities: blinded, charmed, deafened, exhaustion, frightened, paralyzed, petrified, poisoned" ]
      , P [ T "Senses: blindsight 60 ft. (blind beyond this radius), passive Perception 10" ]
      , P [ T "Languages: —" ]
      , P [ T "Challenge: 1/8 (25 XP)" ]
      , P [ T "Voice Lock. The vox seeker must move toward and attack the source of the nearest voice within 60 feet of it, to the exclusion of all other targets, for as long as it remains operational." ]
      , P [ T "Spider Climb. The vox seeker can climb difficult surfaces, including upside down on ceilings, without needing to make an ability check." ]
      , P [ T "Actions: Pincer. Melee Weapon Attack: +2 to hit, reach 5 ft., one target. Hit: 2 (1d4) piercing damage plus 3 lightning damage." ]
      ]
    }
  ...
  , { title: "Wand Sheath"
    ...
    , description: 
      ...
      , P [ T "* The wand sheath can't be removed from you while you're attuned to it." ]
      , P [ T "* You can insert a wand into the sheath as an action. The sheath can hold only one wand at a time." ]
      , P [ T "* You can retract or extend a wand from the sheath as a bonus action. While the wand is extended, you can use it as if you were holding it, but your hand remains free." ]
...
uncommonItems =
  ...
  , { title: "Alchemy Jug"
    ...
    , description: 
      ...
      , P [ T "Liquids:" ]
      , P [ T "Acid: 8 ounces" ]
      , P [ T "Basic poison	1: 2 ounce" ]
      , P [ T "Beer: 4 gallons" ]
      , P [ T "Honey: 1 gallon" ]
      , P [ T "Mayonnaise: 2 gallons" ]
      , P [ T "Oil: 1 quart" ]
      , P [ T "Vinegar: 2 gallons" ]
      , P [ T "Water, fresh: 8 gallons" ]
      , P [ T "Water, salt: 12 gallons" ]
      , P [ T "Wine: 1 gallon" ]
      ]
    }
