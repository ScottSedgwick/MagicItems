...
var tapReporter = /* #__PURE__ */ Test_Spec_Reporter_Base.defaultReporter(1)(function (v) {
    ...
    if (v instanceof Test_Spec_Runner_Event.Pending) {
        return bind(get)(function (n) {
            return discard(tellLn("ok " + (show(n) + (" " + (escTitle(v.value0.value1) + " # SKIP -")))))(function () {
    ...
    if (v instanceof Test_Spec_Runner_Event.TestEnd && v.value1 instanceof Test_Spec_Result.Success) {
        return bind(get)(function (n) {
            return discard(tellLn("ok " + (show(n) + (" " + escTitle(v.value0.value1)))))(function () {
                return modify_(function (v1) {
                    return v1 + 1 | 0;
                });
            });
    ...
    if (v instanceof Test_Spec_Runner_Event.TestEnd && v.value1 instanceof Test_Spec_Result.Failure) {
        return bind(get)(function (n) {
            return discard(tellLn("not ok " + (show(n) + (" " + escTitle(v.value0.value1)))))(function () {
                return discard(tellLn(escMsg(Effect_Exception.message(v.value1.value0))))(function () {
                    return discard((function () {
                        var v1 = Effect_Exception.stack(v.value1.value0);
                        ...
                        throw new Error("Failed pattern match at Test.Spec.Reporter.Tap (line 38, column 5 - line 40, column 82): " + [ v1.constructor.name ]);
                    })())(function () {
                        return modify_(function (v1) {
                            return v1 + 1 | 0;
                        });
