    ...
    return function (e) {
        var modifyRunningItems = function (f) {
            var runningItemIsFinished = function (v) {
                ...
                throw new Error("Failed pattern match at Test.Spec.Reporter.Base (line 159, column 33 - line 162, column 44): " + [ v.constructor.name ]);
            };
        ...
        var baseUpdate = function (v) {
            ...
            if (v instanceof Test_Spec_Runner_Event.Pending) {
                return bind(gets(opts.getRunningItems))(function (runningItem) {
                    return unless(Data_Map_Internal.isEmpty(runningItem))(modifyRunningItems(insert(v.value0)(RunningPending.value)));
                });
            };
            ...
            throw new Error("Failed pattern match at Test.Spec.Reporter.Base (line 122, column 18 - line 147, column 33): " + [ v.constructor.name ]);
        };
