...
var show1 = /* #__PURE__ */ Data_Show.show(/* #__PURE__ */ Data_Show.showArray(Test_Spec_Tree.showPathItem));
...
var Suite = /* #__PURE__ */ (function () {
    function Suite(value0, value1) {
        this.value0 = value0;
        this.value1 = value1;
    };
    Suite.create = function (value0) {
        return function (value1) {
            return new Suite(value0, value1);
        };
    };
    return Suite;
})();
...
var TestEnd = /* #__PURE__ */ (function () {
    function TestEnd(value0, value1) {
        this.value0 = value0;
        this.value1 = value1;
    };
    TestEnd.create = function (value0) {
        return function (value1) {
            return new TestEnd(value0, value1);
        };
    };
    return TestEnd;
})();
...
var showExecution = {
    show: function (v) {
        ...
        throw new Error("Failed pattern match at Test.Spec.Runner.Event (line 12, column 10 - line 14, column 31): " + [ v.constructor.name ]);
    }
};
...
var showEvent = {
    show: function (v) {
        ...
        if (v instanceof Suite) {
            return "Suite " + (show4(v.value0) + (show1(v.value1.value0) + (": " + v.value1.value1)));
        };
        if (v instanceof SuiteEnd) {
            return "SuiteEnd " + (show1(v.value0.value0) + (": " + v.value0.value1));
        };
        if (v instanceof Test) {
            return "Test " + (show4(v.value0) + (show1(v.value1.value0) + (" " + v.value1.value1)));
        };
        if (v instanceof TestEnd) {
            return "TestEnd " + (show1(v.value0.value0) + (" " + (v.value0.value1 + (": " + show2(v.value1)))));
        };
        if (v instanceof Pending) {
            return "Pending " + (show1(v.value0.value0) + (" " + v.value0.value1));
        };
        if (v instanceof End) {
            return "End " + show3(v.value0);
        };
        throw new Error("Failed pattern match at Test.Spec.Runner.Event (line 26, column 10 - line 33, column 42): " + [ v.constructor.name ]);
    }
};
export {
    Parallel,
