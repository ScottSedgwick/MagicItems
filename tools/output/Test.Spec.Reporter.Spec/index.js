...
var lookup = /* #__PURE__ */ Data_Map_Internal.lookup(/* #__PURE__ */ Data_Tuple.ordTuple(/* #__PURE__ */ Data_Ord.ordArray(Test_Spec_Tree.ordPathItem))(Data_Ord.ordString));
...
var printActionGeneric = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Test.Spec.Reporter.Spec (line 61, column 1 - line 61, column 60): " + [ x.constructor.name ]);
    },
    from: function (x) {
...
var print = function (dictMonadState) {
    ...
    return function (dictMonadWriter) {
        ...
        return function (path) {
            var indent = function ($117) {
                return Test_Spec_Style.indent(Data_Array.length($117));
            };
            return function (v) {
                ...
                if (v instanceof PrintTest && v.value1 instanceof Test_Spec_Result.Failure) {
                    return bind1(modify(function (s) {
                        ...
                        $84.numFailures = s.numFailures + 1 | 0;
                        return $84;
                    }))(function (v1) {
                ...
                throw new Error("Failed pattern match at Test.Spec.Reporter.Spec (line 71, column 14 - line 84, column 65): " + [ v.constructor.name ]);
            };
        };
    };
};
    ...
    update: function (v) {
        ...
        if (v instanceof Test_Spec_Runner_Event.TestEnd) {
            return bind(get)(function (v1) {
                return when(Data_Maybe.isNothing(lookup(new Data_Tuple.Tuple(v.value0.value0, v.value0.value1))(v1.runningItems)))(print1(v.value0.value0)(new PrintTest(v.value0.value1, v.value1)));
            });
        };
