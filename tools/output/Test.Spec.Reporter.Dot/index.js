...
var dotReporter = function (v) {
    ...
    return Test_Spec_Reporter_Base.defaultReporter(-1 | 0)(function (v1) {
        if (v1 instanceof Test_Spec_Runner_Event.TestEnd && v1.value1 instanceof Test_Spec_Result.Success) {
            return wrap(Test_Spec_Style.styled(Test_Spec_Speed.toStyle(v1.value1.value0))("."));
        };
        if (v1 instanceof Test_Spec_Runner_Event.TestEnd && v1.value1 instanceof Test_Spec_Result.Failure) {
