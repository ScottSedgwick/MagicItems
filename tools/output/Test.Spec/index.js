        ...
        return function ($$var) {
            return function (action) {
                return bind(liftAff(Effect_Aff_AVar.take($$var)))(function (v) {
                    ...
                    throw new Error("Failed pattern match at Test.Spec (line 321, column 31 - line 327, column 33): " + [ v.constructor.name ]);
                });
            };
        };
    };
...
var mapSpec = function (dictFunctor) {
    var mapSpecTree1 = mapSpecTree(dictFunctor);
    return function (f) {
        return mapSpecTree1(f)(identity);
    };
};
        ...
        return function (f) {
            var onTest = function (name) {
                return over(Test_Spec_Tree.Item)(function (item) {
                    var e = function (g) {
                        return g((function () {
                            var $229 = f(new TestWithName(name));
                            return function ($230) {
                                return $229(item.example(Data_Function.applyFlipped($230)));
                            };
                        })());
                    };
                    return {
...
var focus = function () {
    return function (dictMonad) {
        return over(SpecT)(Control_Monad_Writer_Trans.mapWriterT(Data_Functor.map(((dictMonad.Bind1()).Apply0()).Functor0())(map(function (xs) {
            var $224 = any(any1((function () {
                var $231 = un(Test_Spec_Tree.Item);
                return function ($232) {
                    return (function (v) {
                        return v.isFocused;
                    })($231($232));
...
var describeOnly = function () {
    return function (dictMonad) {
        var $236 = map2(focus1(dictMonad));
        var $237 = describe(dictMonad);
        return function ($238) {
            return $236($237($238));
        };
    };
...
var collect = function (dictFunctor) {
    var $239 = Data_Functor.map(dictFunctor)(Test_Spec_Tree.discardUnfocused);
    var $240 = Control_Monad_Writer_Trans.execWriterT(dictFunctor);
    var $241 = un(SpecT);
    return function ($242) {
