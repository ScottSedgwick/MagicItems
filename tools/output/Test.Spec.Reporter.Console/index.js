...
var printSummary = function (dictMonadWriter) {
    ...
    var printPending = function (p) {
        ...
        throw new Error("Failed pattern match at Test.Spec.Reporter.Console (line 68, column 5 - line 68, column 34): " + [ p.constructor.name ]);
    };
    return function ($129) {
        return (function (v) {
        ...
        })(Test_Spec_Summary.summarize($129));
    };
};
...
var printActionGeneric = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Test.Spec.Reporter.Console (line 81, column 1 - line 81, column 60): " + [ x.constructor.name ]);
    },
    from: function (x) {
                    ...
                    return discard1((function () {
                        ...
                        return discard1(tellLn(Test_Spec_Style.styled(append1(Test_Spec_Style.bold)(Test_Spec_Style.magenta))(intercalate(" \xbb ")(Test_Spec_Tree.parentSuiteName(path)))))(function () {
                            return put((function () {
                                ...
                                $98.lastPrintedSuitePath = new Data_Maybe.Just(path);
                                return $98;
                            })());
                        });
                    })())(function () {
